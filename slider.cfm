...
<div class="dwuserEasyRotator" style="width: 800px; height: 400px; position:relative; text-align: left;" data-erConfig="{autoplayEnabled:false, audio_controllerWidth:390, randomize:true, lpp:'102-105-108-101-58-47-47-47-85-115-101-114-115-47-101-119-97-105-47-68-111-99-117-109-101-110-116-115-47-69-97-115-121-82-111-116-97-116-111-114-80-114-101-118-105-101-119-47-112-114-101-118-105-101-119-95-115-119-102-115-47', wv:1}" data-erName="banner_slider" data-erTID="{4vqlz4txld6612824038531}">
	<div data-ertype="content" style="display: none;"><ul data-erlabel="Main Category">
	<li>
		<img class="main" src="../photos/6.jpg" />
		<img class="thumb" src="../photos/6.jpg" />
	</li>
	<li>
		<img class="main" src="../photos/5.jpg" />
		<img class="thumb" src="../photos/5.jpg" />
	</li>
	<li>
		<img class="main" src="../photos/4.jpg" />
		<img class="thumb" src="../photos/4.jpg" />
	</li>
	<li>
		<img class="main" src="../photos/3.jpg" />
		<img class="thumb" src="../photos/3.jpg" />
	</li>
	<li>
		<img class="main" src="../photos/2.jpg" />
		<img class="thumb" src="../photos/2.jpg" />
	</li>
	<li>
		<img class="main" src="../photos/1.jpg" />
		<img class="thumb" src="../photos/1.jpg" />
	</li>
</ul>
</div>
